...
@section('title', __('admin.packages.edit_title'))
@section('page-title', __('admin.packages.edit_title'))
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-primary">{{ __('admin.packages.edit') }}</h2>
                <p class="text-gray-600">{{ $package->name_ar }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="name_tr"
                               value="{{ old('name_tr', $package->name_tr) }}"
                               required
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description_ar"
                              rows="2"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary">{{ old('description_ar', $package->description_ar) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="currency"
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary">
                            <option value="SYP" {{ $package->currency === 'SYP' ? 'selected' : '' }}>{{ __('admin.currency_syp') }}</option>
                            <option value="TRY" {{ $package->currency === 'TRY' ? 'selected' : '' }}>🇹🇷 ₺ (TRY)</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number"
                               name="ads_limit"
                               value="{{ old('ads_limit', $package->ads_limit) }}"
                               required
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary">
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-3 bg-gray-50 rounded-lg space-y-2">
                    <div class="flex items-center gap-3">
                        <input type="checkbox"
                               ...
                               id="featured_ads"
                               value="1"
                               {{ ($package->featured_ads || old('featured_ads')) ? 'checked' : '' }}
                    ...
                    <div class="featured-limit-wrap {{ ($package->featured_ads || old('featured_ads')) ? '' : 'hidden' }} ml-8">
                        <label class="block text-xs text-gray-600 mb-1">{{ __('admin.packages.featured_ads_limit') }}</label>
                        <input type="number" name="featured_ads_limit" value="{{ old('featured_ads_limit', $package->featured_ads_limit ?? 0) }}" min="0"
                ...
                <div class="p-3 bg-gray-50 rounded-lg space-y-2">
                    <div class="flex items-center gap-3">
                        <input type="checkbox"
                               ...
                               id="urgent_ads"
                               value="1"
                               {{ ($package->urgent_ads || old('urgent_ads')) ? 'checked' : '' }}
                    ...
                    <div class="urgent-limit-wrap {{ ($package->urgent_ads || old('urgent_ads')) ? '' : 'hidden' }} ml-8">
                        <label class="block text-xs text-gray-600 mb-1">{{ __('admin.packages.urgent_ads_limit') }}</label>
                        <input type="number" name="urgent_ads_limit" value="{{ old('urgent_ads_limit', $package->urgent_ads_limit ?? 0) }}" min="0"
                               class="w-24 px-2 py-1 border border-gray-300 rounded text-sm">
                        <span class="text-xs text-gray-500 mr-1">(0 = {{ __('admin.packages.unlimited') }})</span>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <input type="checkbox"
                           ...
                           value="1"
                           {{ $package->priority_support ? 'checked' : '' }}
                ...
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    <input type="checkbox"
                           ...
                           value="1"
                           {{ $package->homepage_display ? 'checked' : '' }}
                           class="w-5 h-5 text-secondary border-gray-300 rounded focus:ring-secondary">
                    <label class="text-sm font-semibold text-gray-700">
