...
@section('page-title', __('admin.categories.create_title'))
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-2xl font-bold text-primary">{{ __('admin.categories.add_new') }}</h2>
        </div>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description_en"
                              rows="3"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary">{{ old('description_en') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description_tr"
                              rows="3"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary">{{ old('description_tr') }}</textarea>
                </div>
            </div>
        </div>

        @include('admin.categories.partials.ad-images-settings', [
            'record' => (object) ['ad_images_mode' => 'user_upload', 'ad_images_max' => null, 'ad_gallery_images' => []],
            'showInherit' => false,
        ])
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-3">
                    <input type="checkbox"
                           ...
                           value="1"
                           {{ old('enable_negotiation', true) ? 'checked' : '' }}
                           class="w-5 h-5 text-secondary border-gray-300 rounded focus:ring-secondary">
                    <label class="text-sm font-semibold text-gray-700">
