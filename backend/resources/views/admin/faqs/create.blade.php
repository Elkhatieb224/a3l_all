...
@section('page-title', __('admin.faqs.create_title'))
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-md p-6 mb-6">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-2xl font-bold text-primary">{{ __('admin.faqs.create_title') }}</h2>
        </div>
    </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           placeholder="{{ __('admin.faqs.question_ar_placeholder') }}">
                    @error('question_ar')
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary"
                           placeholder="{{ __('admin.faqs.question_en_placeholder') }}">
                    @error('question_en')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                           name="question_tr"
                           value="{{ old('question_tr') }}"
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary"
                           placeholder="{{ __('admin.faqs.question_tr_placeholder') }}">
                    @error('question_tr')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="answer_ar"
                              ...
                              required
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary"
                              placeholder="{{ __('admin.faqs.answer_ar_placeholder') }}">{{ old('answer_ar') }}</textarea>
                    @error('answer_ar')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="answer_en"
                              ...
                              required
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary"
                              placeholder="{{ __('admin.faqs.answer_en_placeholder') }}">{{ old('answer_en') }}</textarea>
                    @error('answer_en')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="answer_tr"
                              ...
                              required
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-secondary"
                              placeholder="{{ __('admin.faqs.answer_tr_placeholder') }}">{{ old('answer_tr') }}</textarea>
                    @error('answer_tr')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
