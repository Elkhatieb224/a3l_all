...
@section('title', __('frontend.legal.privacy_title'))
    ...
    <div class="bg-gradient-to-r from-primary to-blue-900 text-white py-8 sm:py-12">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                <h1 class="text-3xl sm:text-4xl font-bold mb-4">{{ __('frontend.legal.privacy_title') }}</h1>
                <p class="text-blue-100 text-lg">{{ __('frontend.legal.privacy_subtitle') }}</p>
            </div>
        </div>
    </div>
