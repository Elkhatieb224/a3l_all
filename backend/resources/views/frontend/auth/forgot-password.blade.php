...
<head>
    ...
    <title>{{ __('frontend.auth.password_reset_title') }} - {{ __('frontend.site_name') }}</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl font-bold text-gray-800">{{ __('frontend.auth.password_reset_request_title') }}</h2>
                <p class="text-sm text-gray-600 mt-2">{{ __('frontend.auth.password_reset_request_message') }}</p>
            </div>
            ...
            <form action="{{ route('password.send-code') }}" method="POST" class="space-y-4">
                @csrf
                <div>
                    <label for="email" class="block text-sm font-semibold text-gray-700 mb-2">{{ __('frontend.auth.email') }}</label>
